...
> Let’s walk through a simple example and see this behavior clearly.
...
> But first you have about something thats helps understand this a lot easier.
>
> Spark provides a tool called the **Spark UI** where you can see:
>
> - Jobs  
> - Stages  
> - Tasks  
...
>
> If something is slow, this is where you go to understand why.
...
### Scene 4 — Lazy Execution (Critical Concept)
...
> Even though we wrote multiple lines of code…
>
> Spark does not execute them immediately.
>
> Lazy Evaluation makes these transformations — like `groupBy` and `count` — to not execute right away.
>
> Instead, Spark builds a plan of what needs to be done.
>
> Only when we call an action — like `show()` — does Spark actually start execution.

---

### Scene 5 — Execution Model (Job → Stage → Task)
...
### Scene 6 — Connecting Execution to Code
...
### Scene 7 — Common Mistake (Correction)
